...
public:
	...
	static UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API UExampleEditorSettings* Get();
	static UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API const UExampleEditorSettings* GetConst();
