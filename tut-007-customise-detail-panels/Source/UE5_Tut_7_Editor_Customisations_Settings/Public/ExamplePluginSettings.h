...
public:
	...
	static UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API UExamplePluginSettings* Get();
	static UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API const UExamplePluginSettings* GetConst();

	void UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API SetExampleFloat(const float InFloat);
	
	// Can override UObject functions like PostInitProperties

	UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API virtual FName GetCategoryName() const override
	{
	...
	UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API virtual FName GetContainerName() const override
	{
		return TEXT("Project");
	}
	
#if WITH_EDITOR
	UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API virtual FText GetSectionText() const override
	{
	...
	UE5_TUT_7_EDITOR_CUSTOMISATIONS_SETTINGS_API virtual FText GetSectionDescription() const override
	{
		// Example of using NSLOCTEXT for namespacing
		return NSLOCTEXT("FUE5_Tut_7_Editor_Customisations_SettingsModule", "SectionDesc", "Example section description");
	}
#endif
};
